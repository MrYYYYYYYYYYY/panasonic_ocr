...
class ArgsParser(ArgumentParser):
    ...
    def parse_args(self, argv=None,arg = None):
...
def train(config,
    ...
    for epoch in range(start_epoch, epoch_num + 1):
        ...
        max_iter = len(train_dataloader)  if platform.system(
...
def eval(model,
    ...
    with paddle.no_grad():
        ...
        max_iter = len(valid_dataloader) if platform.system(
...
def preprocess(is_train=False, args = None):
    FLAGS = ArgsParser().parse_args(args)

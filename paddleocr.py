...
MODEL_URLS = {
    '2.1': {
        'det': {
            ...
            'en':{
                'url':
                'https://paddleocr.bj.bcebos.com/PP-OCRv2/chinese/en_ppocr_mobile_v2.0_det_infer.tar',
            }
        },
        'rec': {
            'ch': {
            ...
            'en':{
                'url':
                'https://paddleocr.bj.bcebos.com/PP-OCRv2/chinese/en_number_mobile_v2.0_rec_infer.tar',
                #'.paddleocr/2.2.1/ocr/rec/en/en_number_mobile_v2.0_rec_infer/',
                'dict_path': './ppocr/utils/dict/pcb_dict.txt'
            }
        },
        'cls': {
            'ch': {
